...
/**
 * @class WheelView
 * The custom widget subclass View, with completely rerendered drawing, using
 * grapics library
 * Dedicately handle the scrolling guesture
 */
public class WheelView extends View {
   ...
   * @param widthMesureSpec horizontal spece requirement imposed by the parent
   * @param heightMeasureSpec vertical space requirements as imposed by the
   * parent.
   * At a high level, onMesure like that:
   * 1. the function is called ith width and height measure specifications,
   * which should be treated requirements for the restrictions on the widt and
   * height measurements you should produce
   * 2. Your component's onMeasure method should calculate a measurement witdth
   * and height which will be required to render the component. It should try to
   * stay withing the speecifications passed in.
   * 3. Once the width and height are calculated, then setMeasureDimension
   */
	@Override
