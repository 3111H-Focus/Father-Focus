 ...
 * For efficiency propose
 * Basically work as a stack, every time the every time push the items in the
 * offset into it, and pop whenever we need one
 */
...
public class WheelRecycle {
   ...
   * All teh cached items are removed from original layout
   *
   * @param layout the layout containing items to be cached
   * @param firstItem the number of first item in layout
   * @param range teh range of current items
   * @param teh new value of the first item number
   */
  public int recycleItems(
      LinearLayout layout, 
      int firstItem, 
      ItemsRange range) {
    int index = firstItem;
